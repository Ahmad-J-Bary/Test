...
## 📁 **Project Structure** <a id="project-structure"></a>
 ...
 ├── apps/
 │   └── desktop-mobile/       # Tauri + React main app
 ├── packages/
 │   ├── grq-ui/               # Component library
 │   ├── grq-core/             # Business logic & services
 │   └── grq-api-bindings/     # Shared data interfaces
 ├── crates/
 │   └── grq-engine/           # Rust engine & core database
 └── locales/                  # Localized documentation
 ```
